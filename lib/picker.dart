  ...
  List<Widget> _buildHeaderViews(BuildContext context) {
    ...
    items.add(Expanded(
      child: picker.title == null
          ? SizedBox()
          : DefaultTextStyle(
              style: (theme!.textTheme.titleLarge ?? theme!.textTheme.titleLarge)?.copyWith(
                    fontSize: Picker.DefaultTextSize,
                  ) ??
  ...
  static Widget? _buildButton(BuildContext context, String? text, Widget? widget, TextStyle? textStyle, bool isCancel,
    ...
    if (widget == null) {
      ...
      return TextButton(
          ...
          onPressed: onPressed,
          child: Text(_txt,
              overflow: TextOverflow.ellipsis, textScaler: MediaQuery.of(context).textScaler, style: textStyle));
    } else {
